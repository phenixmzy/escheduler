...
import cn.escheduler.dao.model.AlertGroupUserNames;
...
public interface AlertGroupMapper {
    ...
    @Results(value = {@Result(property = "id", column = "id", id = true, javaType = Integer.class, jdbcType = JdbcType.INTEGER),
        @Result(property = "groupName", column = "group_name", javaType = String.class, jdbcType = JdbcType.VARCHAR),
        @Result(property = "userNames", column = "user_names",  javaType = String.class, jdbcType = JdbcType.VARCHAR)
    })
    @SelectProvider(type = AlertGroupMapperProvider.class, method = "queryAlertGroupUserNamesList")
    List<AlertGroupUserNames> queryAlertGroupUserNamesList();
}
