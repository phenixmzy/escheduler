...
public class UserMapperProvider {
    ...
    public String queryUserPaging(Map<String, Object> parameter) {
        return new SQL() {
            {
                SELECT("u.id,u.user_name,u.user_password,u.user_type,u.email,u.phone,u.weixin,u.vv,u.tenant_id,u.create_time,u.update_time,t.tenant_name," +
