...
const router = new Router({
  routes: [
    ...
    },
    {
      path: '/gantt',
      name: 'gantt',
      component: resolve => require(['../pages/gantt/index'], resolve),
      meta: {
        title: `gantt`
      },
      redirect: {
      ...
      children: [
        {
          path: '/gantt/workflow',
          name: 'workflow',
          component: resolve => require(['../pages/gantt/pages/index'], resolve),
          meta: {
            title: `${i18n.$t('Workflow orchestration')}`
          }
        }
      ]
    }
