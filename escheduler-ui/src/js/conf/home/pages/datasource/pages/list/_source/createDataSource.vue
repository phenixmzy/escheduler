        ...
        <m-list-box-f>
          ...
          <template slot="content">
            <x-radio-group v-model="type" size="small">
              ...
              <x-radio :label="'MONGODB'">MONGODB</x-radio>
              <x-radio :label="'HBASE'">HBASE</x-radio>
              <x-radio :label="'ES'">ES</x-radio>
              <x-radio :label="'FLINK'">FLINK</x-radio>
              <x-radio :label="'REDIS'">REDIS</x-radio>
