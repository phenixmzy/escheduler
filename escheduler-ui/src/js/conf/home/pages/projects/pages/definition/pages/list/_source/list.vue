...
<!--          </th>-->
          ...
          <th width="70">
            <span>{{$t('WarningGroup Name')}}</span>
          </th>
          <th width="70">
           <span>{{$t('Warning Type')}}</span>
          </th>
          <th width="80">
            <span>{{$t('Crontab')}}</span>
          </th>
          <!-- <th width="250">
            <span>{{$t('User Names')}}</span>
          </th> -->
          <th width="240">
...
<!--          <td><span class="ellipsis">{{item.desc}}</span></td>-->
          ...
          <td><span data-toggle="tooltip" :title="item.userNames" class="name-title">{{item.warningGroupName}}</span></td>
          <td><span >{{item.warningType}}</span></td>
          <td><span >{{item.crontab}}</span></td>
          <!-- <td><span >{{item.userNames}}</span></td> -->
          <td>
