  ...
  <m-popup
    ...
    <template slot="content">
      <div class="create-user-model">
        ...
        <m-list-box-f>
          <template slot="name">{{$t('Vv')}}</template>
          <template slot="content">
            <x-input
              type="input"
              v-model="vv"
              :placeholder="$t('Please enter vv')">
            </x-input>
          </template>
        </m-list-box-f>
        <m-list-box-f>
          <template slot="name">{{$t('Weixin')}}</template>
          <template slot="content">
            <x-input
              type="input"
              v-model="weixin"
              :placeholder="$t('Please enter weixin')">
            </x-input>
          </template>
        </m-list-box-f>
        <m-list-box-f>
      ...
      if (this.isADMIN) {
        Promise.all([this._getQueueList(), this._getTenantList()]).then(() => {
          if (this.item) {
            ...
            this.userPassword = ''
            this.vv = this.item.vv
            this.weixin = this.item.weixin
