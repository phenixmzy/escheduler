<template>
  <div class="nav-model">
    ...
    <div class="nav-box">
      ...
      <div class="clearfix list" >
        <div class="nav-links">
          <router-link :to="{ path: '/warning-groups'}" tag="a" active-class="active">
            <span><i class="iconfont">&#xe693;</i>{{$t('Warning manage')}}</span><b></b>
          </router-link>
        </div>
      </div>
      <div class="clearfix list" >
        <div class="nav-links">
          <router-link :to="{ path: '/gantt'}" tag="a" active-class="active">
            <span><i class="iconfont">&#xe693;</i>{{$t('intelligent scheduling')}}</span><b></b>
          </router-link>
        </div>
      </div>
      <div class="clearfix list" >
      ...
      <transition name="slide-fade">
        <div class="m-nav-list" v-if="mIsNav">
          <ul @click="mIsNav = false">
            ...
            <router-link :to="{ path: '/warning-groups'}" tag="li" active-class="active">
              <i class="iconfont">&#xe693;</i>
              <span>{{$t('Warning manage')}}</span>
            </router-link>
            <router-link :to="{ path: '/gantt'}" tag="li" active-class="active">
              <i class="iconfont">&#xe693;</i>
              <span>甘特图</span>
            </router-link>
