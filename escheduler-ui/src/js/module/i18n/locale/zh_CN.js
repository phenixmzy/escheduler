...
export default {
  ...
  'Please enter vv': '请输入VV',
  'Please enter weixin': '请输入微信',
  ...
  'Please enter group type': '请输入组类型',
  'Group Type': '组类型',
  'Remarks': '备注',
  'SMS': '短信',
  'Managing Users': '管理用户',
  ...
  'Recover tolerance fault process': '恢复失败重试的工作流',
  ...
  'yarnSlots':'yarn 分配 slots 数',
  'yarnContainer':'yarnContainer 数',
  'yarnJobManagerMemory':'yarnJob 内存数',
  'yarnTaskManagerMemory':'yarnTask 内存数',
  'yarnName':'yarnName',
  'Please enter the task name': '请输入任务名称',
  'Task name cannot be empty':'任务名称不能为空',
  'The name is limited to 30 characters':'yarnName 限制30字符',
  'yarnQueue':'yarnQueue',
  'Http Url':'请求地址',
  'Http Method':'请求类型',
  ...
  'Scheduling operations':'调度运维',
  'Workflow orchestration':'工作流编排',
  'Time-consuming gantt chart':'耗时甘特图'
}
