...
public class FlinkTask extends AbstractYarnTask {
  ...
  public void init() {
    ...
    logger.info("flink task params after set queue {}", flinkParameters.toString());
  ...
  protected String buildCommand() {
    ...
    logger.info("flink task args after build: {}", args);

    String command = ParameterUtils
            .convertParameterPlaceholders(String.join(" ", args), taskProps.getDefinedParams());

    for (String key : taskProps.getDefinedParams().keySet()) {

      String value = taskProps.getDefinedParams().get(key);

      System.out.println("Key = " + key + ", Value = " + value);
      logger.info("flink taskProps.getDefinedParams() : {}", "Key = " + key + ", Value = " + value);

    }
    logger.info("flink task command definedParams: {}", taskProps.getDefinedParams());
