            ...
            try {
                ...
                if(checkTimeout){
                    ...
                    if (remainTime < 0) {
                        ...
                        // send warn mail
                        alertDao.sendTaskTimeoutAlert(processInstance.getWarningGroupId(),processDefine.getReceivers(),processDefine.getReceiversCc(),taskInstance.getId(),taskInstance.getName(),processDefine.getProjectName(),processDefine.getName(),processInstance.getName());
                        checkTimeout = false;
                    }
                }
