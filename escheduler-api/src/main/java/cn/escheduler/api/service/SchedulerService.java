...
public class SchedulerService extends BaseService {
    ...
    public Map<String, Object> insertSchedule(User loginUser, String projectName, Integer processDefineId, String schedule, WarningType warningType,
        ...
        if(scheduleParam.getCrontab().startsWith("*")){
            logger.error(scheduleParam.getCrontab() + " Deny execution per second");

            putMsg(result, Status.REQUEST_PARAMS_DENY_EXECUTION_PER_SECOND_ERROR, scheduleParam.getCrontab());
            return result;
        }
