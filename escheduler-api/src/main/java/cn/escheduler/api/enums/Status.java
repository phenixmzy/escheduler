...
//    DB_OPERATION_ERROR(10005, "database operation error"),
    ...
    UPDATE_ALERT_GROUP_ERROR(10030,"update alert group error"),
    ...
    REQUEST_PARAMS_DENY_EXECUTION_PER_SECOND_ERROR(10143, "request parameter {0} deny execution per second"),
    ONLY_UPDATE_YOUR_ALERT_GROUP_ERROR(10145,"只能修改属于你创建的告警组"),
    ONLY_DELETE_YOUR_ALERT_GROUP_ERROR(10145,"只能删除属于你创建的告警组"),
...
//    RESOURCE_EMPTY(20003, "resource file is empty"),
     ...
     * opinion feedback
     */
    QUERY_OPINION_FEEDBACK_LIST_PAGING_ERROR(10146,"query opinion feedback list paging error"),
    CREATE_OPINION_FEEDBACK_ERROR(110001,"create opinion feedback error"),
    UPDATE_OPINION_FEEDBACK_ERROR(110002,"update opinion feedback error"),
