...
public class UsersController extends BaseController{
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "queue", value = "QUEUE", dataType = "String", example = "100"),
            @ApiImplicitParam(name = "email", value = "EMAIL", dataType = "String", example = "100"),
            @ApiImplicitParam(name = "phone", value = "PHONE", dataType = "String", example = "100"),
            @ApiImplicitParam(name = "weixin", value = "WEIXIN", dataType = "String", example = "100"),
            @ApiImplicitParam(name = "vv", value = "VV", dataType = "String", example = "100")
    })
    ...
    public Result createUser(@ApiIgnore @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
                                                    ...
                                                    @RequestParam(value = "vv", required = false) String vv) {
        logger.info("login user {}, create user, userName: {}, email: {}, tenantId: {}, userPassword: {}, phone: {},weixin: {},vv: {}, user queue: {}",
                loginUser.getUserName(), userName, email, tenantId, Constants.PW_DEFAULT, phone,weixin,vv,queue);

        try {
            Map<String, Object> result = usersService.createUser(loginUser, userName, userPassword,email,tenantId, phone,weixin,vv,queue);
    ...
    public Result updateUser(@ApiIgnore @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
                                                     ...
                                                     @RequestParam(value = "weixin", required = false) String weixin,
                                                     @RequestParam(value = "vv", required = false) String vv) {
        logger.info("login user {}, updateProcessInstance user, userName: {}, email: {}, tenantId: {}, userPassword: {}, phone: {},weixin: {},vv: {}, user queue: {}",
                loginUser.getUserName(), userName, email, tenantId, Constants.PW_DEFAULT, phone,queue);
        try {
            Map<String, Object> result = usersService.updateUser(id, userName, userPassword, email, tenantId, phone,weixin,vv, queue);
            return returnDataList(result);
        }catch (Exception e){
