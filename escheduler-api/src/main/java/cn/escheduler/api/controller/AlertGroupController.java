...
public class AlertGroupController extends  BaseController{
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "groupType", value = "GROUP_TYPE", dataType ="String"),
    ...
    public Result createAlertgroup(@ApiIgnore @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
                                   ...
                                   @RequestParam(value = "groupType[]") List<String> groupType,
        ...
        try {
            ...
            for (int i = 0; i < groupType.size(); i++) {
                if(i == 0){
                    type = groupType.get(i);
                }else{
                    type = type +","+groupType.get(i);
                }
            }
            Map<String, Object> result = alertGroupService.createAlertgroup(loginUser, groupName, type,desc);
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "groupName", value = "GROUP_NAME", required = true, dataType = "String"),
            @ApiImplicitParam(name = "groupType", value = "GROUP_TYPE", required = true, dataType ="String"),
            @ApiImplicitParam(name = "desc", value = "DESC",  dataType ="String")
    })
    ...
    public Result updateAlertgroup(@ApiIgnore @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
        ...
        try {
            ...
            Map<String, Object> result = alertGroupService.updateAlertgroup(loginUser, id, groupName, type, desc);
            return returnDataList(result);
