...
public class FlinkParameters extends AbstractParameters {
    ...
    public int getYarnSlots() {
        return yarnSlots;
    }

    public void setYarnSlots(int yarnSlots) {
    ...
    public void setWhetherOnline(boolean whetherOnline) {
    ...
    public String toString() {
        return "FlinkParameters{" +
                ...
                ", yarnJobManagerMemory='" + yarnJobManagerMemory + '\'' +
                ", yarnTaskManagerMemory='" + yarnTaskManagerMemory + '\'' +
