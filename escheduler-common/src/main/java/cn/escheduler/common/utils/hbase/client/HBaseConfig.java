...
public class HBaseConfig {
    ...
    public static Configuration getConfiguration() {
        ...
        //configuration.set("hbase.zookeeper.quorum", "awstst-master,awstst-masterbak,awstst-datanode01");
        configuration.set("hbase.zookeeper.quorum", "bts-masterbak,bts-datanode01,bts-datanode02,bts-datanode03,bts-datanode04");
        configuration.set("hbase.zookeeper.property.clientPort", "2181");
        configuration.set("hbase.client.retries.number", "3");
        configuration.set("hbase.rpc.timeout", "50000");
