package cn.escheduler.common.utils.hbase.client;

import cn.escheduler.common.utils.hbase.HBaseSqlContants;
import cn.escheduler.common.utils.hbase.entity.PageResult;
import cn.escheduler.common.utils.hbase.exceptions.NoRowKeyException;
...
public class HBaseUtils {
    ...
    public static HTable getHtable(Connection connection, String tableName) {
        if (connection == null) {
            return null;
        }
     ...
     * @return
     */
    public static List<Result> getResults(Connection connection, String tableName, Scan scan,
                                          Map<String, List<String>> columnMap) {
        if (connection == null || Strings.isNullOrEmpty(tableName) || scan == null) {
            return null;
        }
    ...
    public static List<Result> getResults(Connection connection, String tableName, Scan scan, Long offset, Long rowCount, Map<String, List<String>> resultColumn) {
        ...
        try {
            ...
            Filter pageFilter = new PageFilter(endIndex);
