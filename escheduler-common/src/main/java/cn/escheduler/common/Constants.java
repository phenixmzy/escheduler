...
public final class Constants {
    ...
    public static final String FLINK_YARN_QUERU = "-yqu";
    ...
    public static final String FLINK_QUEUE_MANAGE = "root.flink";


    /** FTP basic directory **/
    public static final String FTP_BASE_PATH = "/var/ftp/pub/";

    /** FTP local character encoding  **/
    public static String  LOCALCHARSET = "GBK";

    /** FTP  In the agreement, the specified file name is encoded as iso-8859-1 **/
    public static String   SERVERCHARSET= "ISO-8859-1";

    /** FTP UTF-8  Character Encoding **/
    public static final String CHARSET_UTF8 = "UTF-8";

    /** FTP OPTS UTF8 String constant **/
    public static final String OPTS_UTF8 = "OPTS UTF8";

    /** FTP Set buffer size 4M **/
