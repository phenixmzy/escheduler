...
import cn.escheduler.common.utils.HbaseUtils;
...
/**
 * data source of hbase
 */
public class HbaseDataSource extends BaseDataSource {
  ...
  public void isConnectable(){
    ...
    try {
      ...
      boolean isConnection = hbaseUtils.getConnectionState(getDatabase());
      if(!isConnection){
