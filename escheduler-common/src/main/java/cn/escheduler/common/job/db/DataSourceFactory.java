  ...
  public static BaseDataSource getDatasource(DbType dbType, String parameter) {
    try {
      switch (dbType) {
        ...
        case MONGODB:
          return JSONUtils.parseObject(parameter, MongodbDataSource.class);
        case HBASE:
          return JSONUtils.parseObject(parameter, HbaseDataSource.class);
        case ES:
          return JSONUtils.parseObject(parameter, EsDataSource.class);
        default:
          return null;
      }
    } catch (Exception e) {
